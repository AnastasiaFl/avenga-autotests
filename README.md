...
## Overview
This repository contains an end-to-end (E2E) test automation framework built with Playwright. The framework is designed to test the functionality of the Sauce Labs demo application, ensuring modularity, scalability, and maintainability.
